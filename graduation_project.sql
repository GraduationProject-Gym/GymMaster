...
CREATE TABLE `class_equipments` (
  ...
  CONSTRAINT `class_equipments_class_id_foreign` FOREIGN KEY (`class_id`) REFERENCES `gym_classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `class_exerciess` (
  ...
  CONSTRAINT `class_exerciess_class_id_foreign` FOREIGN KEY (`class_id`) REFERENCES `gym_classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `exercises` (
  ...
  `no_of_tiems` int NOT NULL DEFAULT '10',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `memberships` (
  ...
  `subscribe_type` enum('Daily','weekly','Monthly','Yearly') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `reviews_trainee_id_foreign` FOREIGN KEY (`trainee_id`) REFERENCES `trainees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_trainer_id_foreign` FOREIGN KEY (`trainer_id`) REFERENCES `trainers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedules` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `class_id` bigint unsigned NOT NULL,
  `nameDay` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `schedules_class_id_foreign` (`class_id`),
  CONSTRAINT `schedules_class_id_foreign` FOREIGN KEY (`class_id`) REFERENCES `gym_classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subscriptions` (
  ...
  `bill_image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `user_id` bigint unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_classes` (
  ...
  CONSTRAINT `user_classes_class_id_foreign` FOREIGN KEY (`class_id`) REFERENCES `gym_classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2024-09-25 15:44:52
